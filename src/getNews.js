...
/**
 * textに入力された引数のローマ字変換を返す
 * modeで訓令かヘボンかを指定
 * @param {string} text 変換する文字列
 * @param {string} mode [hebon|kunrei]  
 */
function toRome(text, mode)
{
  let result;
  if (mode == 'kunrei') {
    result = kanaToRoman(text, 'kunrei', {longSound:'hyphen'});
  } else if (mode == 'hebon') {
 ...
 */
 function kanaToRoman(targetStr, type, options) {
  ...
  var romanMap = {
      ...
      'さ' : 'sa', 'し' : { hepburn : 'shi', kunrei : 'si' }, 'す' : 'su', 'せ' : 'se', 'そ' : 'so',
      'た' : 'ta', 'ち' : { hepburn : 'chi', kunrei : 'ti' }, 'つ' : { hepburn : 'tsu', kunrei : 'tu' }, 'て' : 'te', 'と' : 'to',
      'な' : 'na', 'に' : 'ni', 'ぬ' : 'nu', 'ね' : 'ne', 'の' : 'no',
      'は' : 'ha', 'ひ' : 'hi', 'ふ' : { hepburn : 'fu', kunrei : 'hu' }, 'へ' : 'he', 'ほ' : 'ho',
      'ま' : 'ma', 'み' : 'mi', 'む' : 'mu', 'め' : 'me', 'も' : 'mo',
      'や' : 'ya', 'ゆ' : 'yu', 'よ' : 'yo',
      'ら' : 'ra', 'り' : 'ri', 'る' : 'ru', 'れ' : 're', 'ろ' : 'ro',
      'わ' : 'wa', 'ゐ' : 'wi', 'ゑ' : 'we', 'を' : { hepburn : 'o', kunrei : 'wo' }, 'ん' : 'n',
      'が' : 'ga', 'ぎ' : 'gi', 'ぐ' : 'gu', 'げ' : 'ge', 'ご' : 'go',
      'ざ' : 'za', 'じ' : { hepburn : 'ji', kunrei : 'zi' }, 'ず' : 'zu', 'ぜ' : 'ze', 'ぞ' : 'zo',
      'だ' : 'da', 'ぢ' : { hepburn : 'ji', kunrei : 'di' }, 'づ' : { hepburn : 'zu', kunrei : 'du' }, 'で' : 'de', 'ど' : 'do',
      ...
      'ぢゃ' : { hepburn : 'dya', kunrei : 'zya' }, 'ぢぃ' : 'dyi', 'ぢゅ' : { hepburn : 'dyu', kunrei : 'zya' }, 'ぢぇ' : 'dye', 'ぢょ' : { hepburn : 'dyo', kunrei : 'zya' },
